...
Sentinel3_data<-list()
Sentinel3_data_Info<-matrix(,nrow=length(json_file),ncol=9)
colnames(Sentinel3_data_Info)<-c("Identifier","Longitude","Latitude","Basin","River","Time_start","Time_end","WaterSurfRef_Alt","Satellite")
