...
for (xx in 1:length(HYDRO_data_VENETO_managed))
{
  ...
  PosTsent<-which(Sentinel3_data_Info$Identifier==STAZIONI_ALL_INFO$SENTINEL[Pos_VENETO])
  ...
  SENT_HYDRO_data_VENETO[[xx]]<-data.frame( merge(Sentinel3_data_managed[[PosTsent]],HYDRO_data_VENETO_managed[[xx]],
